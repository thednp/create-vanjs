...
A Single Page Application (SPA) starter template for VanJS with client-side routing and TypeScript support. Perfect for developing type-safe multi-page SPAs.
