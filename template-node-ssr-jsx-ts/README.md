...
A Server-Side Rendering (SSR/MPA) starter template for VanJS with JSX-enabled and TypeScript support. Perfect for type-safe SEO-friendly apps with React-like syntax.
